...
use squealy::{
	...
	ExecutableDeleteUsingQuery, ExecutableInsertQuery, ExecutableSelectQuery, ExecutableUpdateQuery,
	HAppend, HList, HNil, InsertQuery, InsertRows, InsertableTable, IntoInsertSelect,
	NoRuntimeParams, ParamWriter, PredicateNodes, PreparableDeleteQuery, PreparableInsertQuery,
	PreparableSelectQuery, PreparableUpdateQuery, PreparedMutationQuery, PreparedParamValues,
	PreparedSelectQuery, Projectable, ProjectionShape, QueryBuilder, RenderInsertRows,
	...
	SetSelectModifiers, SetTail, SourceAlias, TableProjection, UpdateFromQuery, UpdateQuery,
	UpdateableTable,
};

use crate::{sql, TestBackend, TestConnection, TestError};
	...
	Projection: RenderProjectable<TestBackend>,
{
	...
	pub fn write_sql(&self, writer: &mut impl std::io::Write) -> std::io::Result<()> {
		sql::write_selected_into::<TestConnection, Base, Shape, Projection, _>(&self.selected, writer)
	}
