...
pub trait QueryBuilder: Sized {
	...
	type Select<'builder, 'scope, Base, Shape, Projection>: SelectQuery<
		'builder,
		'scope,
		Base,
		Projection,
	...
	type Insert<'builder, S, Shape, Rows, Returning>: InsertQuery<
		'builder,
		Rows,
		Returning,
		Builder = Self,
	...
	type Update<'builder, S, Shape, Columns, Filters, Returning>: UpdateQuery<
		'builder,
		Columns,
		Filters,
		Returning,
	...
	type Delete<'builder, S, Shape, Filters, Returning>: DeleteQuery<
		'builder,
		Filters,
		Returning,
		Builder = Self,
	...
	type UpdateFrom<'builder, S, O, Columns, Filters>: crate::UpdateFromQuery<
		'builder,
		S,
		O,
		Columns,
	...
	/// `O` is the joined source table; `Filters` the correlation/filter predicates over both sources.
	type DeleteUsing<'builder, S, O, Filters>: crate::DeleteUsingQuery<
		'builder,
		S,
		O,
		Filters,
