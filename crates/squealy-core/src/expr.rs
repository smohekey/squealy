...
{
	type Params =
		<<S::Params as crate::HAppend<Start::Params>>::Output as crate::HAppend<Len::Params>>::Output;
	...
	<PredAst::Params as crate::HAppend<ValAst::Params>>::Output: crate::HAppend<Rest::Params>,
{
	...
	const CONTAINS_NAMED_WINDOW: bool =
		PredAst::CONTAINS_NAMED_WINDOW || ValAst::IS_NAMED_WINDOW_REF || Rest::CONTAINS_NAMED_WINDOW;
}
...
{
	type Columns =
		<<Arms as CaseArmsColumns>::Columns as CombineColumns<<Else as ExprColumns>::Columns>>::Output;
}
...
impl<'scope, T, Arms, Null> CaseBuilder<'scope, T, Arms, Null> {
	...
	pub fn otherwise<E>(
		...
		'scope,
		<<Null as CaseNullOr<<E::Kind as KindNullability>::Nullable>>::Output as CaseNull>::Result<T>,
...
{
	type Params = <<WhenAst::Params as crate::HAppend<ThenAst::Params>>::Output as crate::HAppend<
		Rest::Params,
	>>::Output;
...
impl<'scope, Parts, Ords> Window<'scope, Parts, Ords> {
	...
	pub fn order_by<K, Ast>(self, order: Order<'scope, K, Ast>) -> Window<'scope, Parts, Ords::Output>
	where
	...
	Operand: ExprAst,
{
	...
	where
		F: FnOnce(Window<'scope, WindowNil, WindowNil, NoFrame>) -> Window<'scope, Parts, Ords, Frame>,
		Parts: Clone,
		Ords: Clone,
		Frame: Clone,
...
pub trait ExprVisitor {
	...
	fn visit_window_order_direction(&mut self, direction: OrderDirection) -> Result<(), Self::Error>;
...
{
	type Params =
		<<Operand::Params as crate::HAppend<Lo::Params>>::Output as crate::HAppend<Hi::Params>>::Output;
	...
	K: ExprKind,
{
	...
	pub fn between<'other, Lo, Hi>(self, lo: Lo, hi: Hi) -> ColumnBetween<'scope, K, Lo::Ast, Hi::Ast>
	where
		Lo: IntoExpr<'other>,
		Hi: IntoExpr<'other>,
	...
	Ast::Params: crate::HAppend<<R::Ast as ExprAst>::Params>,
{
	...
	fn sub(self, other: R) -> Self::Output {
		Expr::<K, Ast>::binary::<SubtractExpr<K, R::Kind>, _>(self.ast, ArithmeticOp::Subtract, other)
	}
}
	...
	Ast::Params: crate::HAppend<<R::Ast as ExprAst>::Params>,
{
	...
	fn mul(self, other: R) -> Self::Output {
		Expr::<K, Ast>::binary::<MultiplyExpr<K, R::Kind>, _>(self.ast, ArithmeticOp::Multiply, other)
	}
}
